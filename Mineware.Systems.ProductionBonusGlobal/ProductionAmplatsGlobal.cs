...
{
    public class ProductionAmplatsGlobal
    {
        #region Fields and Properties
        public static List<ProductionAmplatsGlobalTSysSettings> SystemSettingsProduction = new List<ProductionAmplatsGlobalTSysSettings>();        
