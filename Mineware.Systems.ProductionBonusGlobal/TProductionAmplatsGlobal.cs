...
using Mineware.Systems.ProductionBonusGlobal;
using System;
...
namespace Mineware.Systems.ProductionAmplatsGlobal
{


    public static class TProductionAmplatsGlobal
    {

        public static ProductionAmplatsBonusMenuStructure SysMenu = new ProductionAmplatsBonusMenuStructure();
       
        static TProductionAmplatsGlobal()
        {
